  ...
  return (
    <div>
      {!user ? (
        ...
        <Link href={"/dashboard"} className="border text-sm rounded-3xl text-gray-300 block w-full md:p-2 p-1 bg-gray-700 border-gray-600 hover:scale-105 transition-all duration-200">
          <Image
            src={user.image}
            alt=".."
            width={36}
